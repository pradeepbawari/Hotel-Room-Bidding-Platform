...
import { fetchRooms, searchRoomPage, updateHotelId } from '../../redux/actions';
...
function SearchPageRooms() {
    ...
    const roomData = useSelector((state) => state.searchHotelRoomPage.searchHotelRoomPage);
    
    useEffect(()=>{
        dispatch(searchRoomPage(search))
    },[dispatch, search])
