...
import { fetchHotels, updateHotelId } from '../../redux/actions';
...
function Hotels() {
    ...
    const bidsNow = (hotelName, hotelId) => {
        ...
        sessionStorage.setItem('bidHotel', JSON.stringify({'hotelId': hotelId, 'roomId': hotelName}))
        navigate(`/bids-in-hotel/${url}`);  
    }

    if(hotelsData.length==0) return <div className='flex justify-center'>Loading...</div>
    ...
    return (
        <div className='md:flex justify-between'>
            ...
            <div className='flex-1'>
                {hotelsData && hotelsData.length && hotelsData.map((hotel, index) => (
