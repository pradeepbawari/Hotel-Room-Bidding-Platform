  ...
  return (
    <>
      <nav className="space-y-3 md:space-y-0 md:flex md:space-x-20 uppercase py-2 px-4">
        <Link to="/" className="block hover:text-blue-600 py-3">Dashboard</Link>
        <Link to="/deal-in-hotels" className="block hover:text-blue-600 py-3">Hotel Deals</Link>
        <Link to="/deal-in-hotel-rooms" className="block hover:text-blue-600 py-3">Room Deals</Link>
